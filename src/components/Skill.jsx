    ...
    return (
        <div className='min-h-screen'> 
            ...
            <div className='Other bg-gray-900 p-6 rounded-2xl mx-[10%] border-2 border-gray-400 mb-[10%] mt-[25%] lg:mt-[5%]'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-6 xl:grid-cols-6'>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" /><p>Python</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/java/java-original.svg" /><p>Java</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/go/go-original-wordmark.svg" /><p>Go</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vscode/vscode-original.svg" /><p>VS Code</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nginx/nginx-original.svg" /><p>Nginx</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/putty/putty-original.svg" /><p>Putty</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/netlify/netlify-original.svg" /><p>Netlify</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/linux/linux-original.svg" /><p>Linux</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/helm/helm-original.svg" /><p>Helm</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/intellij/intellij-original.svg" /><p>Intellij Idea</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/photoshop/photoshop-original.svg" /><p>Photoshop</p></div>
                    <div className='testing items-center mx-4 rounded-2xl border-gray-800 gap-[5%] p-6 hover:border-blue-500 duration-200 hover:bg-gray-600 text-white border-2 mb-[20%] flex flex-col'><img className='mb-[3%] h-12 w-12' alt="#" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postman/postman-original.svg" /><p>Postman</p></div>
                </div>
            </div>
        </div>
    )
